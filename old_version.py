...
def source(x_min, x_max, y_min, y_max, theta_min, theta_max, n=1000):
    ...
    theta_min = theta_min * np.pi / 180  # translation degrees -> radians
    theta_max = theta_max * np.pi / 180  # translation degrees -> radians
...
if __name__ == "__main__":
    ...
    aperture_angle = 45 * np.pi / 180  # 45 degrees aperture
